...
class BLIP_Pretrain(nn.Module):
    def __init__(self,
        ...
        if vit == 'base':
            ...
            load_custom_pretrained(self.visual_encoder,
        ...
        self.text_encoder = BertModel.from_pretrained(
            'indobenchmark/indobert-base-p1', config=encoder_config, add_pooling_layer=False)
        ...
        self.text_decoder = BertLMHeadModel.from_pretrained(
            'indobenchmark/indobert-base-p1', config=decoder_config)
